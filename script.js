...
const highscoreSection = D.querySelector("#highscore");
...
const scoreProcess = (message) => {
  if (message === WIN_MESSAGE) {
    ...
    if (score > highscoreSection.innerText) highscoreSection.innerText = score;
    return;
  }
...
againButton.addEventListener("click", () => {
  ...
  mainSection.style.backgroundColor = "#202";
